    ...
    <header className="bg-[#53B175] text-green-900 py-4 shadow-md">
      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row sm:items-center justify-between space-y-2 sm:space-y-0">
        ...
        <div className="flex justify-center sm:justify-end w-full sm:w-auto">
          <button className="flex items-center space-x-2 bg-white text-[#53B175] font-medium px-4 py-2 rounded-full shadow hover:bg-green-50 transition duration-200">
            <FaSignInAlt />
            <span>Login</span>
          </button>
        </div>
