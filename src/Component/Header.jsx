...
const Header = () => {
  ...
  return (
   ...
   {/* Modal */}
{isModalOpen && (
<div className="fixed inset-0 z-20 flex justify-center items-center  bg-transparent">
  <div
    className="bg-white p-6 rounded-t-2xl lg:rounded-lg shadow-md w-full sm:w-full md:w-[80%] lg:w-96 transition-all backdrop-blur-sm"
  ...
  >
    ...
    <button
      className="mt-4 text-[#53B175] font-medium w-full"
      onClick={closeModal}
    >
      Close
    </button>
